...
covid_growth_us = tibble(widespread$time[widespread$time>1], diff(widespread[,"USA"]), diff(widespread[, "NL"]), diff(widespread[,"Italy"]), diff(widespread[,"China"]))
colnames(covid_growth_us) = c("time", "USA", "NL", "Italy", "China")
